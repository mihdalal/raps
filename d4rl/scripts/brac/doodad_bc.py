...
doodad.run_python(
    ...
    verbose=True,
    cli_args='--alsologtostderr --save_freq=1000 --sub_dir=0 --env_name=%s --identifier="train_bc" --agent_name=bc --total_train_steps=300000 --n_train=1000000 --model_arch=0 --opt_params=0'
    % env_name
    #'--gin_bindings="train_eval_offline.model_params=((200, 200),)" ' + \
    #'--gin_bindings="train_eval_offline.batch_size=256" ' + \
    #'--gin_bindings="train_eval_offline.optimizers=((\'adam\', 5e-4),)"'
